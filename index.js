...
class Student extends Lambdasian {
  constructor(childAttr){
    super(childAttr)
    this.previousBackground = childAttr.previousBackground,
    this.className = childAttr.className,
    this.favSubjects = childAttr.favSubjects,
    this.grade = childAttr.grade;
  }
